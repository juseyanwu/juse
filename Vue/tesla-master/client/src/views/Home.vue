...
.img1 {
  ...
  width: 100%;
  height: 100%;
  background: url("https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Homepage-Model-Y-Desktop-CN.jpg");
...
.img5 {
  ...
  width: 100%;
  height: 100%;
  background: url("https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Desktop_SolarPanels.jpg");
...
.img6 {
  ...
  width: 100%;
  height: 100%;
  background: url("https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Homepage-Accessories-Desktop-CN.jpg");
  background-position: 0px -140px;
  background-size: 100% 140%;
  .box {
    opacity: 100%;
